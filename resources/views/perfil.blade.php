...
@section('content')
    ...
    <div class="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 relative overflow-hidden">
        ...
        <div class="relative">
            <!-- Banner superior -->
            <div class="relative w-full h-80 bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 overflow-hidden">
                <!-- Patrón decorativo -->
                ...
                <div class="absolute bottom-[-60px] left-1/2 transform -translate-x-1/2">
                    <div class="relative">
                        ...
                        <!-- Badge decorativo -->
                        <div class="absolute -top-2 -right-2 w-10 h-10 bg-gradient-to-r from-amber-500 to-yellow-500 rounded-full flex items-center justify-center shadow-lg">
            ...
            <div class="relative max-w-4xl mx-auto pt-20 pb-12 px-4">
                ...
                <div class="text-center mb-12">
                    <h1 class="text-4xl font-bold bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 bg-clip-text text-transparent mb-4">
                        {{ Auth::user()->name }}
                    </h1>
                    <p class="text-gray-600 text-lg mb-6">Tu perfil nutricional personalizado</p>
                    
                    <button id="edit-profile-btn"
                        class="group relative overflow-hidden bg-gradient-to-r from-emerald-500 via-emerald-600 to-teal-600 text-white px-8 py-4 rounded-2xl font-semibold shadow-xl transform hover:scale-105 hover:shadow-2xl transition-all duration-300 border border-emerald-400/20">
                        ...
                        <div class="relative flex items-center justify-center gap-3">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 20h9M16.5 3.5a2.121 2.121 0 113 3L7 19l-4 1 1-4L16.5 3.5z"></path>
                            </svg>
                ...
                <div class="backdrop-blur-xl bg-white/80 rounded-3xl shadow-2xl border border-white/20 p-8 mb-8 transform hover:scale-[1.01] transition-all duration-300">
                    <div class="text-center mb-8">
                        <div class="inline-flex items-center gap-3 bg-gradient-to-r from-emerald-50 to-teal-50 px-6 py-3 rounded-2xl border border-emerald-200/50 mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <!-- Email -->
                        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200/50 transform hover:scale-105 transition-all duration-300">
                        ...
                        <!-- Edad -->
                        <div class="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-6 border border-purple-200/50 transform hover:scale-105 transition-all duration-300">
                            <div class="flex items-center gap-3 mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-purple-600 font-medium">{{ Auth::user()->age ?? 'No especificada' }} años</p>
                                </div>
                            </div>
                        </div>

                        <!-- Género -->
                        <div class="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-6 border border-amber-200/50 transform hover:scale-105 transition-all duration-300">
                            <div class="flex items-center gap-3 mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-amber-600 font-medium">{{ Auth::user()->gender == 'male' ? 'Hombre' : (Auth::user()->gender == 'female' ? 'Mujer' : 'No especificado') }}</p>
                                </div>
                            </div>
                        </div>

                        <!-- Peso -->
                        <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-200/50 transform hover:scale-105 transition-all duration-300">
                            <div class="flex items-center gap-3 mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-green-600 font-medium">{{ Auth::user()->weight_kg ?? 'No especificado' }} kg</p>
                                </div>
                            </div>
                        </div>

                        <!-- Altura -->
                        <div class="bg-gradient-to-r from-teal-50 to-cyan-50 rounded-2xl p-6 border border-teal-200/50 transform hover:scale-105 transition-all duration-300">
                            <div class="flex items-center gap-3 mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-teal-600 font-medium">{{ Auth::user()->height_cm ?? 'No especificada' }} cm</p>
                                </div>
                            </div>
                        </div>
                        ...
                        @if(Auth::user()->weight_kg && Auth::user()->height_cm)
                            ...
                            @endphp
                            <div class="bg-gradient-to-r {{ $color }} rounded-2xl p-6 border transform hover:scale-105 transition-all duration-300">
                                <div class="flex items-center gap-3 mb-3">
                                    <div class="w-10 h-10 bg-gradient-to-r {{ $iconColor }} rounded-xl flex items-center justify-center">
                                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="text-center">
                    <div class="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-50 to-teal-50 px-4 py-2 rounded-full border border-emerald-200/50">
                        ...
                        <span class="text-emerald-700 text-sm font-medium">Mantén tu perfil actualizado para mejores recomendaciones</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="edit-modal" class="fixed inset-0 z-50 hidden bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 animate-fadeIn">
        <div class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl w-full max-w-2xl max-h-[85vh] overflow-hidden border border-white/20 transform animate-slideUp">
            <!-- Header del modal -->
                ...
                <form method="POST" action="{{ route('perfil.actualizar') }}" class="space-y-6">
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-white rounded-2xl p-4 border border-gray-200/50">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <label class="group flex items-center gap-3 p-3 rounded-xl hover:bg-emerald-50 transition-all duration-200 cursor-pointer border border-gray-200 hover:border-emerald-300">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="bg-gradient-to-r from-gray-50 to-white rounded-2xl p-4 border border-gray-200/50">
                            ...
                            <input type="number" name="weight_kg" value="{{ Auth::user()->weight_kg }}" min="1" max="500" step="0.1"
                                class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 bg-white/70">
                        </div>
                        <div class="bg-gradient-to-r from-gray-50 to-white rounded-2xl p-4 border border-gray-200/50">
                            <label for="height_cm" class="block text-sm font-semibold text-gray-700 mb-2">Altura (cm)</label>
    ...
    @if (session('success'))
        <div id="toast-success"
            class="fixed top-8 right-[-100%] z-[9999] backdrop-blur-xl bg-green-500/90 text-white px-6 py-4 rounded-2xl shadow-2xl transition-all duration-500 ease-out border border-green-400/30 flex items-center gap-3">
