...
@section('content')
        ...
        <div class="relative max-w-6xl mx-auto pt-16 pb-12 px-4">
            ...
            <div class="text-center mb-12">
                <div class="inline-flex items-center gap-3 mb-4">
                    <div class="w-14 h-14 bg-gradient-to-r from-amber-500 to-yellow-500 rounded-2xl flex items-center justify-center shadow-lg">
                        <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path>
                        </svg>
                    </div>
                    <h1 class="text-4xl font-bold bg-gradient-to-r from-amber-600 via-yellow-600 to-orange-600 bg-clip-text text-transparent">
                        Tus Logros
                    </h1>
                </div>
            ...
            <div class="backdrop-blur-xl bg-white/80 rounded-3xl shadow-2xl border border-white/20 p-8 mb-8 transform hover:scale-[1.01] transition-all duration-300">
                <div class="text-center mb-6">
                    <div class="inline-flex items-center gap-3 bg-gradient-to-r from-amber-50 to-yellow-50 px-6 py-3 rounded-2xl border border-amber-200/50 mb-4">
            ...
            @else
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    @foreach ($allAchievements as $achievement)
                        ...
                        <div class="group backdrop-blur-xl bg-white/80 rounded-3xl shadow-2xl border border-white/20 p-6 transform hover:scale-105 hover:shadow-3xl transition-all duration-500 relative overflow-hidden {{ $completed ? 'ring-2 ring-amber-400/50' : '' }}">
                            
                            <!-- Efecto de brillo para logros completados -->
                            @if($completed)
                                <div class="absolute inset-0 bg-gradient-to-r from-amber-400/10 via-yellow-400/10 to-orange-400/10 animate-pulse"></div>
                            @endif
                            
                            <!-- Header del logro -->
                            <div class="relative flex items-center gap-4 mb-4">
                                <div class="relative">
                                    <div class="w-16 h-16 {{ $completed ? 'bg-gradient-to-r from-amber-500 to-yellow-500' : 'bg-gray-300' }} rounded-2xl flex items-center justify-center shadow-lg transition-all duration-300 group-hover:scale-110">
                                        @if($completed)
                                    ...
                                    <!-- Badge de estado -->
                                    @if($completed)
                                        <div class="absolute -top-2 -right-2 w-6 h-6 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full flex items-center justify-center shadow-lg">
                                ...
                                <div class="flex-1">
                                    <h3 class="text-lg font-bold {{ $completed ? 'text-amber-700' : 'text-gray-700' }} group-hover:text-emerald-700 transition-colors duration-300">
                                        {{ $achievement->name }}
                                    </h3>
                            ...
                            <div class="relative">
                                ...
                                <div class="flex justify-between items-center mt-2">
                                    ...
                                    @if($completed)
                                        <div class="inline-flex items-center gap-1 bg-gradient-to-r from-green-50 to-emerald-50 px-2 py-1 rounded-full border border-green-200/50">
                                    ...
                                    @else
                                        <div class="inline-flex items-center gap-1 bg-gradient-to-r from-blue-50 to-indigo-50 px-2 py-1 rounded-full border border-blue-200/50">
                ...
                <div class="mt-12 text-center">
                    <div class="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-50 to-teal-50 px-4 py-2 rounded-full border border-emerald-200/50">
                        ...
                        <span class="text-emerald-700 text-sm font-medium">¡Sigue usando Equilibria para desbloquear más logros!</span>
                    </div>
                </div>
            @endif
        </div>
    ...
    <style>
        ...
        /* Efectos de brillo para logros completados */
        ...
        /* Gradientes personalizados para barras de progreso */
