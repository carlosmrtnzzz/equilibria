        ...
        <div class="relative max-w-5xl mx-auto pt-16 pb-12 px-4">
            ...
            <div class="text-center mb-8">
                <div class="inline-flex items-center gap-3 mb-4">
                    <div class="w-12 h-12 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-2xl flex items-center justify-center shadow-lg">
            ...
            <div class="backdrop-blur-xl bg-white/80 rounded-3xl shadow-2xl border border-white/20 p-6 mb-8 transform hover:scale-[1.01] transition-all duration-300">
                <div id="chat-box" class="h-96 overflow-y-auto bg-gradient-to-br from-gray-50/50 to-white/50 rounded-2xl p-6 shadow-inner border border-gray-100/50 scroll-smooth">
                    ...
                    <div class="flex items-start gap-3 mb-4 opacity-70">
                        ...
                        <div class="bg-white/70 rounded-2xl rounded-tl-sm px-4 py-3 shadow-sm border border-gray-100">
                            <p class="text-gray-700">¡Hola! Soy Equilibria, tu asistente nutricional. ¿En qué puedo ayudarte hoy?</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                <button type="button" id="generarBtn"
                    class="group relative overflow-hidden bg-gradient-to-r from-emerald-500 via-emerald-600 to-teal-600 text-white px-6 py-4 rounded-2xl font-semibold shadow-xl transform hover:scale-105 hover:shadow-2xl transition-all duration-300 border border-emerald-400/20">
                ...
                <button type="button" id="abrirModalBtn"
                    class="group relative overflow-hidden bg-gradient-to-r from-amber-500 via-orange-500 to-yellow-500 text-white px-6 py-4 rounded-2xl font-semibold shadow-xl transform hover:scale-105 hover:shadow-2xl transition-all duration-300 border border-amber-400/20">
                ...
                <button type="button" id="abrirIntrolerancias"
                    class="group relative overflow-hidden bg-gradient-to-r from-purple-500 via-indigo-500 to-blue-500 text-white px-6 py-4 rounded-2xl font-semibold shadow-xl transform hover:scale-105 hover:shadow-2xl transition-all duration-300 border border-purple-400/20">
                    <div class="absolute inset-0 bg-gradient-to-r from-purple-400 to-indigo-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <div class="relative flex items-center justify-center gap-3">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div id="modalCambiarPlatos" class="fixed inset-0 z-50 hidden bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 animate-fadeIn">
    <div class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl w-full max-w-3xl max-h-[85vh] overflow-hidden border border-white/20 transform animate-slideUp">
        <!-- Header del modal -->
...
<div id="modalIntolerancias" class="fixed inset-0 z-50 hidden bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 animate-fadeIn">
            ...
            <form id="formPreferencias" class="space-y-6">
                <div class="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-2xl p-4 border border-purple-100">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <label class="group flex items-center gap-3 p-3 rounded-xl hover:bg-white/70 transition-all duration-200 cursor-pointer">
                        ...
                        <label class="group flex items-center gap-3 p-3 rounded-xl hover:bg-white/70 transition-all duration-200 cursor-pointer">
                            <input type="checkbox" id="is_lactose_intolerant" name="is_lactose_intolerant"
                                class="w-5 h-5 text-purple-600 bg-white border-2 border-gray-300 rounded-lg focus:ring-purple-500 focus:ring-2 transition-all duration-200">
                            <span class="text-gray-700 group-hover:text-gray-900 font-medium">Intolerancia a la lactosa</span>
                        </label>

                        <label class="group flex items-center gap-3 p-3 rounded-xl hover:bg-white/70 transition-all duration-200 cursor-pointer">
                            <input type="checkbox" id="is_fructose_intolerant" name="is_fructose_intolerant"
                                class="w-5 h-5 text-purple-600 bg-white border-2 border-gray-300 rounded-lg focus:ring-purple-500 focus:ring-2 transition-all duration-200">
                            <span class="text-gray-700 group-hover:text-gray-900 font-medium">Intolerancia a la fructosa</span>
                        </label>

                        <label class="group flex items-center gap-3 p-3 rounded-xl hover:bg-white/70 transition-all duration-200 cursor-pointer">
                            <input type="checkbox" id="is_histamine_intolerant" name="is_histamine_intolerant"
                                class="w-5 h-5 text-purple-600 bg-white border-2 border-gray-300 rounded-lg focus:ring-purple-500 focus:ring-2 transition-all duration-200">
                            <span class="text-gray-700 group-hover:text-gray-900 font-medium">Intolerancia a la histamina</span>
                        </label>

                        <label class="group flex items-center gap-3 p-3 rounded-xl hover:bg-white/70 transition-all duration-200 cursor-pointer">
                            <input type="checkbox" id="is_sorbitol_intolerant" name="is_sorbitol_intolerant"
                                class="w-5 h-5 text-purple-600 bg-white border-2 border-gray-300 rounded-lg focus:ring-purple-500 focus:ring-2 transition-all duration-200">
                            <span class="text-gray-700 group-hover:text-gray-900 font-medium">Intolerancia al sorbitol</span>
                        </label>

                        <label class="group flex items-center gap-3 p-3 rounded-xl hover:bg-white/70 transition-all duration-200 cursor-pointer">
                            <input type="checkbox" id="is_casein_intolerant" name="is_casein_intolerant"
                                class="w-5 h-5 text-purple-600 bg-white border-2 border-gray-300 rounded-lg focus:ring-purple-500 focus:ring-2 transition-all duration-200">
                            <span class="text-gray-700 group-hover:text-gray-900 font-medium">Intolerancia a la caseína</span>
                        </label>

                        <label class="group flex items-center gap-3 p-3 rounded-xl hover:bg-white/70 transition-all duration-200 cursor-pointer">
                            <input type="checkbox" id="is_egg_intolerant" name="is_egg_intolerant"
                                class="w-5 h-5 text-purple-600 bg-white border-2 border-gray-300 rounded-lg focus:ring-purple-500 focus:ring-2 transition-all duration-200">
                            <span class="text-gray-700 group-hover:text-gray-900 font-medium">Intolerancia al huevo</span>
                        </label>
                    </div>
                </div>
            </form>
