        ...
        <div class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden border border-white/20 transform animate-slideUp">
            ...
            <div class="bg-gradient-to-r from-purple-500 to-indigo-500 p-4 text-center">
                <div class="flex items-center justify-center gap-2 mb-1">
                    ...
                    <h2 class="text-xl font-bold text-white">Intolerancias Alimentarias</h2>
                </div>
                <p class="text-white/90 text-sm">Personaliza tu experiencia nutricional</p>
            </div>
            ...
            <div class="p-4">
                <form id="formPreferencias" class="space-y-4">
                    <div class="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-3 border border-purple-100">
                        <h3 class="text-gray-800 font-semibold mb-3 flex items-center gap-2 text-sm">
            ...
            <!-- Footer más compacto -->
            <div class="bg-gray-50/80 backdrop-blur-sm p-4 flex justify-end gap-2 border-t border-gray-200/50">
                <button type="button" id="cancelarPreferenciasBtn"
                    class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 cursor-pointer text-sm">
                    Cancelar
                </button>
                <button type="submit" form="formPreferencias"
                    class="px-4 py-2 bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white rounded-lg font-medium shadow-lg transition-all duration-300 transform hover:scale-105 cursor-pointer text-sm">
                    Guardar
                </button>
            </div>
        </div>
