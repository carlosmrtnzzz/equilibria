...
@section('title', 'Chat con Equilibria | ')
...
@section('content')
    ...
    <div id="modalIntolerancias"
        ...
        <div
            class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl w-full max-w-2xl md:max-w-3xl overflow-hidden border border-white/20 transform animate-slideUp">
            <!-- Header más compacto -->
            <div class="bg-gradient-to-r from-purple-500 to-indigo-500 p-4 md:p-6 text-center">
                <div class="flex items-center justify-center gap-2 md:gap-4 mb-1">
                    <div class="w-8 h-8 md:w-10 md:h-10 bg-white/20 rounded-full flex items-center justify-center">
                        <svg class="w-4 h-4 md:w-5 md:h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                    </div>
                    <h2 class="text-xl md:text-2xl font-bold text-white">Intolerancias Alimentarias</h2>
                </div>
                <p class="text-white/90 text-sm md:text-base">Personaliza tu experiencia nutricional</p>
            </div>

            <!-- Contenido más compacto -->
            <div class="p-4 md:p-6">
                <form id="formPreferencias" class="space-y-4 md:space-y-6">
                    <div class="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-3 md:p-5 border border-purple-100">
                        <h3 class="text-gray-800 font-semibold mb-3 flex items-center gap-2 text-sm md:text-base">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 md:gap-4">
                            ...
                            <label
                                class="group flex items-center gap-2 md:gap-3 p-2 md:p-3 rounded-lg hover:bg-white/70 transition-all duration-200 cursor-pointer">
                                <input type="checkbox" id="is_celiac" name="is_celiac"
                                    class="w-5 h-5 md:w-6 md:h-6 text-purple-600 bg-white border-2 border-gray-300 rounded-lg focus:ring-purple-500 focus:ring-2 transition-all duration-200">
                                <span class="text-gray-700 group-hover:text-gray-900 font-medium text-sm md:text-base">Celiaquía
                                    (Gluten)</span>
                            </label>
                            ...
                            <label
                                ...
                                <input type="checkbox" id="is_lactose_intolerant" name="is_lactose_intolerant"
                                    class="w-5 h-5 md:w-6 md:h-6 text-purple-600 bg-white border-2 border-gray-300 rounded-lg focus:ring-purple-500 focus:ring-2 transition-all duration-200">
                                <span class="text-gray-700 group-hover:text-gray-900 font-medium text-sm md:text-base">Intolerancia a la
                                    lactosa</span>
                            </label>
                            ...
                            <label
                                ...
                                <input type="checkbox" id="is_sorbitol_intolerant" name="is_sorbitol_intolerant"
                                    class="w-5 h-5 md:w-6 md:h-6 text-purple-600 bg-white border-2 border-gray-300 rounded-lg focus:ring-purple-500 focus:ring-2 transition-all duration-200">
                                <span class="text-gray-700 group-hover:text-gray-900 font-medium text-sm md:text-base">Intolerancia al
                                    sorbitol</span>
                            </label>
            ...
            <!-- Footer más compacto -->
            <div class="bg-gray-50/80 backdrop-blur-sm p-4 md:p-6 flex justify-end gap-2 md:gap-4 border-t border-gray-200/50">
                <button type="button" id="cancelarPreferenciasBtn"
                    class="px-4 py-2 md:px-6 md:py-3 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 cursor-pointer text-sm md:text-base">
                    Cancelar
                </button>
                <button type="submit" form="formPreferencias"
                    class="px-4 py-2 md:px-6 md:py-3 bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white rounded-lg font-medium shadow-lg transition-all duration-300 transform hover:scale-105 cursor-pointer text-sm md:text-base">
                    Guardar
                </button>
            </div>
        </div>
