        ...
        <div class="relative z-10 w-full max-w-md mx-auto md:mx-0 md:ml-24 lg:ml-70 px-4 md:px-0">
            <div
                ...
                <a href="{{ route('google.login') }}"
                    class="w-full group relative overflow-hidden bg-white border border-gray-300 text-gray-700 px-6 py-4 rounded-2xl font-semibold shadow-lg transform hover:scale-105 hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-3 mb-10">
